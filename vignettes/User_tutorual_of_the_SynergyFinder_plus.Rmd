...
To facilitate the use of the R package for the drug discovery community, we also provide a web server at http://synergyfinderplus.org/ as a user-friendly interface to enable a more flexible and versatile analysis of drug combination data. In the web application, in addition to the functions in R package, we provide the annotation of drugs and cell lines that are tested in an experiment, including their chemical information, targets and signaling network information.
...
Zheng,S., Wang,W., Aldahdooh,J., Malyutina,A., Shadbahr,T., Pessia,A. and Tang,J. (2021) SynergyFinder Plus: towards a better interpretation and annotation of drug combination screening datasets. bioRxiv, 10.1101/2021.06.01.446564.
